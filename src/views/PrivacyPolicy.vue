...
<template>
    <div class="privacy-policy-view">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Oxsoft Budgets.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Oxsoft Budgets, accessible from <a href="https://www.oxsoftbudgets.com" rel="external nofollow noopener" target="_blank">https://www.oxsoftbudgets.com</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By visiting this page on our website: <a href="https://www.oxsoftbudgets.com/contact">https://www.oxsoftbudgets.com/contact</a></li>
        </ul>
    </div>
</template>
<style scoped>
